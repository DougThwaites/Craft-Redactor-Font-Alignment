...
class RedactorAlignmentPlugin extends BasePlugin
{
	...
	{
		 return Craft::t('Redactor Alignment');
	}
	...
	{
		return Craft::t('Add the redactor alignment plugin.');
	}
	...
	{
		return 'https://github.com/DougThwaites/CraftRedactorFontAlignment/blob/master/README.md';
	}
